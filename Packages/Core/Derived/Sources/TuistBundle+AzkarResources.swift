...
/// Since AzkarResources is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Core_AzkarResources"
    ...
    fatalError("unable to find bundle named Core_AzkarResources")
}()
}
